...
from bluesnail.core.exceptions import SkillNotFoundError
from bluesnail.skills.loader import (
    AgentSkillPackage,
...
from bluesnail.core.types import SkillResult, ToolCall

BUILTIN_SKILLS_DIR = Path(__file__).resolve().parent / "packages"
    ...
    def skill(
        ...
        *,
        ...
        def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
            ...
            skill_parameters = parameters or build_parameters_schema(func)
